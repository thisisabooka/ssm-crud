      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">添加商品信息</h1>
          </div>
          
			<form action="${APP_PATH }/product" method="post">
				<div class="form-group">
					<label>ProductName</label> <input name="productName" type="text" class="form-control"
						placeholder="商品名称（比如苹果）">
				</div>
				<div class="form-group">
					<label>ProductPrice</label> <input name="productPrice" type="text" class="form-control"
						placeholder="商品价格（比如3.10）">
				</div>
				<div class="form-group">
					<label>ProductDescription</label> <input name="productDescription" type="text" class="form-control"
						placeholder="商品描述（比如好吃又便宜）">
				</div>
